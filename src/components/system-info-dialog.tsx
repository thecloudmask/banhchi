      ...
      <DialogContent className="sm:max-w-105 p-0 overflow-hidden border border-border shadow-2xl rounded-3xl bg-background">
        ...
        <div className="bg-card text-foreground pt-6 pb-4 px-6 flex flex-col items-center justify-center text-center relative border-b border-border">
             <div className="flex items-center gap-3 mb-2">
                ...
                <DialogTitle className="text-lg font-black tracking-tight italic">{"ប្រព័ន្ធបញ្ជី (Banhchi)"}</DialogTitle>
            ...
            <DialogDescription className="text-muted-foreground/60 text-[10px] uppercase tracking-widest font-medium">Digital Event Companion</DialogDescription>
        </div>
        ...
        <div className="p-5 bg-background space-y-5">
            ...
            <div className="space-y-3">
                <div className="flex items-center gap-2 text-foreground justify-center">
                    ...
                    <h4 className="font-black text-xs uppercase tracking-wide">{"ជំនួយបច្ចេកទេស"}</h4>
                </div>
                ...
                <div className="flex flex-row items-center gap-4 bg-muted/30 rounded-2xl p-4 border border-border">
                    ...
                    <div className="flex flex-col items-center gap-2 shrink-0">
                        ...
                        <span className="text-[9px] font-bold uppercase tracking-widest text-muted-foreground text-center leading-tight w-20">{"ស្កេន"}</span>
                    </div>
                    ...
                    <div className="flex-1 space-y-3 min-w-0">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div className="overflow-hidden">
                                <div className="text-[10px] text-muted-foreground font-bold uppercase">{"លេខទូរស័ព្ទ"}</div>
                                <div className="text-sm font-black text-foreground font-mono truncate">098 943 324</div>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div className="overflow-hidden">
                                <div className="text-[10px] text-muted-foreground font-bold uppercase">Telegram</div>
                                <a href="https://t.me/mengley_support" target="_blank" rel="noopener noreferrer" className="text-sm font-black text-rose-500 hover:underline truncate block">@mengley_support</a>
                            </div>
                        </div>
                    </div>
                </div>
