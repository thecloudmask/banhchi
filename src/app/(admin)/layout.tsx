        ...
        <div className="container mx-auto max-w-7xl flex h-14 items-center justify-between px-4 sm:px-6">
          ...
          >
            ...
            <div className="hidden xs:flex flex-col items-start leading-none gap-0.5">
              ...
              <span className="text-[8px] font-semibold text-muted-foreground/40 uppercase  ">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2">
            <a href="/" className="group">
              <Button
                variant="ghost"
                size="sm"
                className="h-8 rounded-md gap-2 font-semibold text-[10px] uppercase   text-muted-foreground hover:text-foreground hover:bg-accent border border-transparent hover:border-border transition-all"
              >
                ...
                <span className="hidden sm:inline"><span>មើលគេហទំព័រ</span></span>
              </Button>
            </a>
            <div>
              <ThemeToggle />
            ...
            <Button
              ...
              className="rounded-md hover:bg-rose-500/10 hover:text-rose-500 transition-all p-2 sm:px-3 h-8 font-semibold text-[10px] sm:text-xs uppercase   text-muted-foreground"
            >
              <LogOut className="h-4 w-4 sm:mr-2" />
              <span className="hidden sm:inline"><span>ចាកចេញ</span></span>
            </Button>
          </div>
        </div>
      </header>
