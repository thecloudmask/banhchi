       ...
       <div className="p-8 pb-4 border-b border-border flex items-center justify-between">
          <div className="flex items-center gap-3">
             ...
             <div>
                ...
                <p className="text-[10px] font-black uppercase tracking-widest text-muted-foreground/60">{"ប្រវត្តិប្រតិបត្តិការ"}</p>
             </div>
          </div>
       ...
       <div className="flex-1 overflow-y-auto p-8 pt-6">
          {loading ? (
             ...
             <div className="h-40 flex flex-col items-center justify-center text-center opacity-20 text-muted-foreground">
                ...
                <p className="text-[10px] font-black uppercase tracking-widest">{"មិនទាន់មានសកម្មភាពនៅឡើយ"}</p>
             </div>
          ) : (
             <div className="space-y-6">
                {logs.map((log) => (
                   <div key={log.id} className="relative pl-6 border-l border-border pb-1 last:pb-0">
                      <div className={cn(
                        "absolute -left-1.5 top-0 h-3 w-3 rounded-full border-2 border-background",
                      ...
                      <div className="space-y-1">
                         ...
                         <div className="flex items-center gap-1.5 pt-1 text-[8px] font-black uppercase tracking-widest text-muted-foreground/40">
