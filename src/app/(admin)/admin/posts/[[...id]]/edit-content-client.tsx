        ...
        <div className="flex items-center gap-6">
          ...
          <div>
            ...
            <p className="text-muted-foreground font-bold uppercase text-[10px]">
              កែប្រែព័ត៌មាន និងខ្លឹមសារដែលបានផ្សព្វផ្សាយ
            </p>
          </div>
        </div>
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
                  ...
                  {newImagePreviews.map((preview, index) => (
                    <div
                      key={`new-${index}`}
                      className="relative aspect-square bg-muted rounded-md overflow-hidden border-2 border-dashed border-primary/30 group shadow-md"
                    >
                      <Image
                        src={preview}
