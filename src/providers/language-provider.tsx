...
export const translations: Record<string, Record<Language, string>> = {
  ...
  "merit_making": { en: "Merit-making / Flower Ceremony", kh: "បុណ្យផ្កាសាមគ្គី" },
  ...
  "grand_total": { en: "Grand Total", kh: "សរុបរួម" },
  ...
  "cash_subtotal": { en: "Cash Subtotal", kh: "សរុបលុយសុទ្ធ" },
  ...
  "net_worth_usd": { en: "NET WORTH (USD)", kh: "សរុបជាដុល្លារ (ប៉ាន់ស្មាន)" },
