    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4 font-kantumruy">
      <div className="w-full bg-card border border-border shadow-2xl p-8 rounded-[2rem] max-w-sm space-y-8 text-center animate-in fade-in zoom-in-95 duration-500">
        <div>
          ...
          <h1 className="text-2xl font-black text-foreground tracking-tight uppercase">{t('admin_access')}</h1>
        ...
        <div className="space-y-6">
          <div className="relative">
            ...
            <div className="relative flex justify-center text-[10px]"><span className="bg-card px-4 text-muted-foreground font-bold uppercase tracking-[0.2em]">{t('sign_in_email')}</span></div>
          </div>

          <form onSubmit={handleSubmit} className="space-y-5 text-left">
            <div className="space-y-4">
              <div className="space-y-2">
                <Label className="text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground ml-1">{t('email')}</Label>
                <Input
                  type="email"
              ...
              <div className="space-y-2">
                <Label className="text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground ml-1">{t('password')}</Label>
                <Input
                  type="password"
                  placeholder="••••••••"
                  value={password}
            ...
            <Button 
              type="submit" 
               className="w-full h-12 rounded-xl font-black text-xs uppercase tracking-[0.2em] shadow-xl shadow-primary/20 bg-primary hover:bg-primary/90 text-primary-foreground transition-all active:scale-[0.98]" 
               disabled={loading || googleLoading}
            >
              {loading ? (
                <>
        ...
        <div className="pt-4">
          <Link href="/" className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-600 hover:text-primary transition-colors flex items-center justify-center gap-2">
