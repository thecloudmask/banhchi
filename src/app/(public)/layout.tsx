...
export default function PublicLayout({
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center">
      ...
      <main className="w-full animate-in fade-in slide-in-from-bottom-4 duration-700 relative z-10">
        {children}
      </main>

      <footer className="w-full py-6 text-center text-sm text-muted-foreground border-t border-border bg-background/50 backdrop-blur-sm mt-auto relative z-20">
